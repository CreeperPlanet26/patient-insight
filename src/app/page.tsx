  ...
  return (
    <div className="home-page">
      ...
      <section>
        ...
        <p>Are you feeling sick but unsure about what exactly your disorder is? Well, PatientInsight is here to assist you with personalized health insights! Simply describe your symptoms orally, and our product will take it from there!</p>
